 ...
 * @author Waruna
 */
public class RemoveItemForm extends javax.swing.JPanel {
    ...
    private void itemTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_itemTableMouseClicked
        ...
        if (null != itemCode) {
            int option = JOptionPane.showConfirmDialog(null, "Do You Wont To Remove This Item ?", "Item Remove", JOptionPane.YES_NO_CANCEL_OPTION);
            if (option == 0) {
                try {
                    boolean removeItem = ItemController.removeItem(itemCode);
                    if (removeItem) {
                        JOptionPane.showMessageDialog(null, "Item Remove System !");
                    } else {
                        JOptionPane.showMessageDialog(null, "Item Not Remove !");
                    }
                } catch (ClassNotFoundException | SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Item Not Remove !");
                }
            ...
            JOptionPane.showMessageDialog(null, "Select Item Remove !");
        }
