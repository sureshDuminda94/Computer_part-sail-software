 ...
 * @author Waruna
 */
public class RemoveCustomerForm extends javax.swing.JPanel {
    ...
    private void customerTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customerTableMouseClicked
        ...
        int showConfirmDialog = JOptionPane.showConfirmDialog(null, "You Wont Delete This Customer In System ?", "Remove Customer", JOptionPane.YES_NO_CANCEL_OPTION);
        if (0 == showConfirmDialog) {
            try {
                boolean removeCustomer = CustomerController.removeCustomer(customerId);
                if (removeCustomer) {
                    JOptionPane.showMessageDialog(null, "Customer Remove !");
                }
            } catch (SQLException | ClassNotFoundException ex) {
                JOptionPane.showMessageDialog(null, "Customer Not Remove !");
            }
